...
$read_sql = "select * from albums_board where idx = {$_GET['idx']}";
            ...
            <div class="row">
                <div class="col-12 col-lg-9" style="margin-left: 300px ">
                    ...
                    if ($read_row['name'] == $now_id || $level_row['level'] == 0) {
                        echo "<a href='../board/albumsModify.php?idx={$_GET['idx']}'> <input type=\"submit\" value=\"Modify\" class=\"btn oneMusic-btn-custom mt-5\" style=\"text-align: center\"></a>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
      <a href='../board/albumsDelete.php?idx={$_GET['idx']}'><input type=\"submit\" value=\"Delete\" class=\"btn oneMusic-btn-custom mt-5\" style=\"text-align: center\">
      &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>";
                    }
                    echo "<a href='../php/albums.php'><input type=\"submit\" value=\"List\" class=\"btn oneMusic-btn-custom mt-5\" style=\"text-align: center\"></a>";
                    ?>
