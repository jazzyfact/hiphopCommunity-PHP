...
//$result = mysqli_query($connect,$STATISTICS_QUERY);
    ...
    $insert_sql = $pdo->prepare("insert into  visitor_info ( user_agent, browser, os, page_url, dayofweek,  user_ip, country, regionName,city, lat, lon , timezone ) VALUES ( '$user_agent', '$browser', '$os',  '$page_url', '$dayofweek', '$user_ip', '$country','$regionName' ,'$city' , '$lat' , '$lon' , '$timezone')");
